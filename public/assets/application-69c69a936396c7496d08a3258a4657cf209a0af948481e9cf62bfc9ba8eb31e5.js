...
(function() {
  jQuery(function() {
    var flop_photo, open_search_panel, open_tag_panel;
    ...
    flop_photo = function() {
      ...
      if (pathElm[3] === "photo_get") {
        return $("#photo").attr("src", "/" + pathElm[1] + "/" + pathElm[2] + "/" + "photo_get_rev");
      } else {
        return $("#photo").attr("src", "/" + pathElm[1] + "/" + pathElm[2] + "/" + "photo_get");
      }
    };
    ...
    open_tag_panel = function() {
      return $(".tag-button.active").parent().parent().each(function() {
        return $(this).addClass("in");
      });
    };
    open_tag_panel();
    open_search_panel = function() {
      return $(".member-button.active").parent().parent().each(function() {
        return $(this).addClass("in");
      });
    };
    open_search_panel();
    $(".tag-button").change(function() {
      var $label;
      $label = $(this);
    ...
    return $(".search-button").click(function() {
      ...
      $(".member-button.active input").each(function() {
